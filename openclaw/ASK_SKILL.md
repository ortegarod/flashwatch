---
name: basewhales-ask
description: "Query BaseWhales — pay 0.01 USDC on Base via x402, get AI analysis of recent Base L2 whale activity from Kyro, an agent monitoring flashblocks 24/7. Use when: asking about whale moves, large transfers, wallet patterns, or suspicious activity on Base. NOT for: running your own FlashWatch instance (see SKILL.md for that)."
